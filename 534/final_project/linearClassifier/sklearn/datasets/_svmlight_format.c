...
static const char __pyx_k_Users_EnRatz_repos_scikit_learn[] = "/Users/EnRatz/repos/scikit-learn/sklearn/datasets/_svmlight_format.pyx";
 ...
 */
  ...
  __pyx_codeobj__21 = (PyObject*)__Pyx_PyCode_New(5, 0, 25, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__20, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_Users_EnRatz_repos_scikit_learn, __pyx_n_s_load_svmlight_file, 28, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__21)) __PYX_ERR(0, 28, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
