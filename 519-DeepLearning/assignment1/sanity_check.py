    ...
    def train(self, patterns):
        ...
        for i in range(self.iterations):
            ...
            for p in patterns:
                ...
                if ((p % 100) == 0): print ("100 done")
                if ((p % 1000) == 0): print ("1000 done")
...
def demo():
    ...
    def load_data():
        ...
        for i in range(train_x.shape[0]):
            fart = list((train_x[i,:].tolist(), train_y[i].tolist())) # don't mind this variable name
            out.append(fart)
    ...
    NN = MLP_NeuralNetwork(3072, 100, 1, iterations = 50, learning_rate = 0.5, momentum = 0.5, rate_decay = 0.01)
